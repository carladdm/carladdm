...
**Building deeper experience with:**
...
*...but I like learning other stuff, too 🚀*
...
- **NVIDIA** — Deep Learning Fundamentals (PyTorch & CNN) · Accelerated Computing with CUDA C++
- **MongoDB** — Fundamentals of Data Transformation (Aggregation Pipeline & Querying)
- **IBM** — Cybersecurity Specialization · Agile Principles · Data Analysis Fundamentals
- **Google** — Professional UX Design · Mastering AI with Gemini
- **CompTIA** — Security+
